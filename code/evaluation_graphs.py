...
shotsfired = np.array([14, 8, 4, 7, 2, 12, 11, 11, 5, 16])
swordSwings = np.array([12, 5, 24, 15, 10, 19, 15, 18, 12, 13])
bowSwings = np.array([7, 6, 14, 8, 6, 14, 13, 14, 7, 8])
...
plt.ylabel('Entitiy In Focus in 1 Minute Game')
